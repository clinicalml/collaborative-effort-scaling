...
class OneStageCollaborativeAgent:
    """A basic collaborative agent implemented with ReAct prompting strategy.
    This agent can interact with the environment, send messages to teammates, and wait for teammates to continue.
    ...
    def __init__(
        ...
        self.action_space_description = None
        self.lm = lm
        ...
        self.act_prompt_template = "\n\n".join(
            [
                ...
                prompts["take_next_action_template"],
            ]
        )
    ...
    def start(
        ...
        self.action_space_description = self.context_processor.action_space_to_str(
            action_space=action_space,
            excluded_action_names=None,  # Include both task and collaboration actions
        )
        ...
        logger.info("Basic Collaborative Agent started.")
